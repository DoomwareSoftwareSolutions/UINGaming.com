...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventMembership.teamTag'
        db.add_column(u'events_eventmembership', 'teamTag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventMembership.teamTag'
        db.delete_column(u'events_eventmembership', 'teamTag')
