...
urlpatterns = patterns('',
	...
	url(r'^profileEdit/[A-Za-z0-9]*$',src.utils.api.IndexRequestHandler),
	...
	url(r'^api/eventSearch$',src.events.views.EventSearchAPI),
	...
	url(r'^api/eventMembershipDelete$',src.events.views.EventMembershipDeleteAPI),
